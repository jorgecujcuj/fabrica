                        ...
                        <h4 class="card-title">Proveedores</h4>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('proveedores.create')}}" class="dropdown-item">Agregar</a>
                                </div>
                            </div>
                        ...
                        <table id="order-listing" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('proveedores.show',$proveedore)}}">
                                            {{$proveedore->nombre}}</a>
                                    </td>
                                    ...
                                    <td style="width: 50px;">
                                        ...
                                        $proveedore],'method'=>'DELETE']) !!}

                                        <a class="jsgrid-button jsgrid-edit-button" href="
                                        {{route('proveedores.edit',$proveedore)}}"
                                        title="Editar">
